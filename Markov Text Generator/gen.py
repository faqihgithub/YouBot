...
class Generator:
	...
	def generate(self, word_sep):
		depth = self.db.get_depth()
		sentence = [Parser.SENTENCE_START_SYM] * (depth - 1)
		end_symbol = [Parser.SENTENCE_END_SYM] * (depth - 1)
		...
		return word_sep.join(sentence[depth-1:][:1-depth])
